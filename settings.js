...
global.buttonDefault = [{
   ...
   quickReplyButton: {const fs = require('fs')
const chalk = require('chalk')
const {
   indonesia,
   english,
...
global.owner = ["6281296382470", "62821931157232"] //ganti agar fitur owner bisa di gunakan
...
global.background_welcome = "https://telegra.ph/file/edca4b513ddf29fd52c0e.jpg" // maks size 30kb, agar welcome image nya tdk delay
global.thumbGif = 'https://telegra.ph/file/e90bef3779d3c5812a5d1.mp4'
global.packname = '©AdjiBotz '  //sticker wm ubah
global.author = 'Created By AdjiBotz'  //sticker wm ganti nama kalian
global.sessionName = 'session'
//type menu for menu
